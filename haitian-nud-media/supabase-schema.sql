-- HAITIAN NUD - Supabase Schema Complet (corrigé)
-- ====================================================
...
-- ====================================================
-- FONCTION TRIGGER: Créer utilisateur automatiquement
-- ====================================================
...
-- Trigger: créer un utilisateur dans la table `users` quand un compte auth est créé
...
COMMENT ON TABLE users IS 'Table des utilisateurs, sync avec Supabase Auth. is_admin=false par défaut. Pour rendre un utilisateur admin, UPDATE users SET is_admin=true WHERE email=...';
COMMENT ON TABLE videos IS 'Table des vidéos. is_vip=true pour contenu VIP. published=false = soft-delete.';
COMMENT ON TABLE downloads IS 'Table des téléchargements. Permet de tracker les téléchargements.';
COMMENT ON TABLE tickets IS 'Table des tickets de support. status=open/answered/closed.';
